...
const jobOpenings: JobOpening[] = [
  {
    id: "job-1",
    title: "Heavy Trailer & GCC License Driver",
    category: "Drivers & Transport",
    company: "Al-Futtaim Logistics & Transport",
    location: "Dubai, UAE",
    countryCode: "AE",
    flag: "🇦🇪",
    salary: "AED 4,800 – 6,500 / mo",
    visaType: "Employment Visa & Accommodation",
    openings: 15,
    urgent: true,
    perks: ["Free Company Accommodation", "Overtime & Trip Bonus Extra", "GCC License Transfer Support"],
  },
  {
    id: "job-2",
    title: "6G Pipe Welder & Fabrication Technician",
    category: "Construction & Trades",
    company: "Aramco Contracting Partners",
    location: "Riyadh, Saudi Arabia",
    countryCode: "SA",
    flag: "🇸🇦",
    salary: "SAR 4,500 – 6,200 / mo",
    visaType: "Work Permit & Iqama Provided",
    openings: 12,
    urgent: true,
    perks: ["Free Duty Meals Provided", "2-Year Renewable Iqama", "Overtime Available Daily"],
  },
  {
    id: "job-3",
    title: "CNC Operator & Lathe Machinist",
    category: "Factory & Machining",
    company: "Euro-Precision Manufacturing",
    location: "Munich, Germany",
    countryCode: "DE",
    flag: "🇩🇪",
    salary: "€2,800 – €3,800 / mo",
    visaType: "EU Opportunity Card / Work Permit",
    openings: 8,
    urgent: true,
    perks: ["German B1 Language Support", "PR Pathway in 3 Years", "Paid Annual Vacation"],
  },
  {
    id: "job-4",
    title: "Hotel Restaurant Captain & Senior Waiter",
    category: "Hospitality & Retail",
    company: "Grand Hyatt Hospitality Group",
    location: "Doha, Qatar",
    countryCode: "QA",
    flag: "🇶🇦",
    salary: "QAR 3,800 – 5,500 / mo",
    visaType: "Hospitality Visa Provided",
    openings: 10,
    urgent: false,
    perks: ["Free Accommodation & Meals", "Tips & Service Charge Shares", "Annual Flight Ticket"],
  },
  {
    id: "job-5",
    title: "Certified Elderly Caregiver & Nursing Assistant",
    category: "Healthcare & Caregiving",
    company: "CareHome UK Health Services",
    location: "London, United Kingdom",
    countryCode: "GB",
    flag: "🇬🇧",
    salary: "£2,200 – £3,100 / mo",
    visaType: "Health & Care Worker Visa (Tier 2)",
    openings: 6,
    urgent: false,
    perks: ["NHS Free Healthcare", "5-Year ILR Settlement Path", "Family Visa Eligibility"],
  },
  {
    id: "job-6",
    title: "Construction Site Electrician & Scaffolder",
    category: "Construction & Trades",
    company: "Adriatic Infrastructure Group",
    location: "Zagreb, Croatia",
    countryCode: "HR",
    flag: "🇭🇷",
    salary: "€1,400 – €1,900 / mo",
    visaType: "EU Work Permit & TRC Card",
    openings: 14,
    urgent: true,
    perks: ["Free Company Housing", "Schengen Residence Card", "30-Day Paid Annual Leave"],
  },
];
          ...
          <AnimatePresence mode="popLayout">
            {filteredJobs.map((job, idx) => (
              <motion.div
                ...
                className="group relative rounded-2xl border border-slate-200/90 bg-white p-6 transition-all duration-200 hover:border-emerald-500/50 hover:shadow-md shadow-sm flex flex-col justify-between overflow-hidden"
              >
                <div>
